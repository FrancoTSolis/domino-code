...
print("Generating tip3p data...") 
print("Fix all seed to: ", args.seed)


def get_rotation_matrix():
    """ 
        Function shared by lj, tip3p, 
...
def generate_per_round(round): 
    ...
    temperature = 300 * unit.kelvin # for tip3p 
    chain_length = 10
    # friction = 25. / unit.picosecond
    friction = 1. / unit.picosecond # for tip3p 
    num_mts = 5
    num_yoshidasuzuki = 5
...
suffix = '_tip3p' # '_lj 
store_path = f'data/larger_tip3p_data_{args.window_size}'
log_path = f'data/larger_tip3p_data_{args.window_size}/logs'
